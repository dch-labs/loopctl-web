---
title: "OpenAI client — and its compatible family"
sidebar:
  order: 2
---
...
- [Overview](/providers/overview/) — the full matrix.
- [Structured output](/integration/structured-output/) — the options in action.
