---
title: "SSE — how streaming bytes become events"
sidebar:
  order: 6
---
...
- [Stream events](/core-data/stream-events/) — the vocabulary and the handler.
- [API client](/core-data/api-client/) — implementing your own.
