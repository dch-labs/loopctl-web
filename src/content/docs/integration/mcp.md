---
title: "MCP — using foreign tools, and serving your own"
sidebar:
  order: 2
---
...
- [Tools](/core-data/tools/) — what becomes an MCP tool.
- [Examples tour](/integration/testing/) — the MCP examples, runnable.
