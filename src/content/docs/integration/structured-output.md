---
title: "Structured output — answers you can parse"
sidebar:
  order: 1
---
...
| `Grammar(provider)` [feature: grammar] | sampler-level constraint for local servers — see [grammar](/providers/grammar/) |
...
- [Grammar](/providers/grammar/) — the local-model mode.
- [API client](/core-data/api-client/) — where options are honored or rejected.
