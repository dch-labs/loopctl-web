---
title: "The LLM turn — building and sending one model request"
sidebar:
  order: 3
---
...
These few lines are the entire glue between the LLM turn and the [model fallback system](/safety/fallback/).
...
- [Stream events](/core-data/stream-events/) — the handler's retry/fallback ladder.
