# Reflection & recovery — what to do when a tool fails
...
Remember the interactions: every retry records into the [loop detector](02-loop-detection.md) (identical error texts stack up — mark recoverable errors in your `ToolSignature`), and every retry counts toward the tool's [health stats](06-tool-health.md).

---

## Related pages

- [Tool dispatch](../02-engine/04-tool-dispatch.md) — where this loop lives.
- [Errors](../01-core-data/05-errors.md) — `ToolRecoveryExhausted` decoded.
