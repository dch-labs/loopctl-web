# Loop detection — catching an agent that repeats itself
...
- [Windows, averages, and similarity](../09-principles/07-measuring-repetition.md) — the sliding window and fingerprint hashing this detector is built on.
- [Convergence detection](03-convergence.md) — the sibling detector for repeated *answers*.
- [Tool dispatch](../02-engine/04-tool-dispatch.md) — where the checks plug in.
- [File reference: detection](../07-file-reference/detection.md)
