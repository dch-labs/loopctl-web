# Tool health — circuit breakers per tool [feature: tool_health]
...
3. **Repeated shield blocks count as failures** toward the breaker ([shield](07-tool-shield.md)): once open, the engine's gate refuses first, and the model sees "temporarily unavailable" instead of the shield's reason.
...
- [Circuit breakers](../09-principles/06-circuit-breakers.md) — the pattern, from scratch.
- [Windows, averages, and similarity](../09-principles/07-measuring-repetition.md) — how the EWMA score is computed, with worked numbers.
- [Tool dispatch](../02-engine/04-tool-dispatch.md) — where the gate sits in the pipeline.
- [The shield](07-tool-shield.md) — its refusals feed these breakers.
