# Convergence detection — noticing the model repeats its *answers*
...
- [Windows, averages, and similarity](../09-principles/07-measuring-repetition.md) — the Jaccard word-set similarity this detector uses, with worked examples.
- [Loop detection](02-loop-detection.md) — the sibling detector.
- [Termination](../02-engine/07-termination.md) — where `UserInputRequired` fits.
