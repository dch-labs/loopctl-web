# `#[derive(Tool)]` — the Tool impl, written for you
...
- [Tools](../01-core-data/02-tools.md) — what the macro generates.
- [Presets](04-presets.md) — the Constrained profile pairs beautifully with derived tools.
