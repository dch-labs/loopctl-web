...
Details: the [file reference](../07-file-reference/memory-file.md).
...
Details and defaults: the [file reference](../07-file-reference/memory-extractor.md).
...
Details and defaults: the [file reference](../07-file-reference/memory-consolidate.md).
