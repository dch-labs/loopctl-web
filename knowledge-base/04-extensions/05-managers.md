# LoopManagers — the one bundle of optional parts
...
- [The driver](../02-engine/02-driver-loop.md) — who consumes the bundle.
- Every component's own page: [observers](01-observers.md), [hooks](02-hooks.md), [memory](03-memory.md), [detection](../03-safety/02-loop-detection.md), [fallback](../03-safety/04-fallback.md), [compaction](../02-engine/06-compaction.md), [stream handler](../01-core-data/04-stream-events.md).
