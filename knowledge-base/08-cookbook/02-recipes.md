# Recipes — complete, working patterns
...
Watch for: [output caps](../03-safety/01-middleware.md) — an uncapped `ReadFile` can eat the whole context window (Recipe 5).
...
Order = execution order; first registered is outermost. Rationale per slot: [the middleware page](../03-safety/01-middleware.md).
