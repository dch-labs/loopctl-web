# Anatomy of a run — from your text to the final answer
...
See [Termination — every way a run can end](../02-engine/07-termination.md) for the complete table with code paths.

---

## Where to go next

- [The driver loop](../02-engine/02-driver-loop.md) — everything steps 3–6 do, in full detail.
- [Tool dispatch](../02-engine/04-tool-dispatch.md) — the complete safety pipeline around every tool call.
- [Building a tool](../01-core-data/02-tools.md) — write your own.
