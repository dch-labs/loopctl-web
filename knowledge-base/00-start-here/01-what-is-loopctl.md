...
These are explained in depth in the [Glossary](../GLOSSARY.md); here is the minimum to read on:
...
- [The big idea](02-the-big-idea.md) — how the engine is built and why (the most important page here).
- [Anatomy of a run](03-anatomy-of-a-run.md) — one full run, step by step.
- [The codebase map](04-codebase-map.md) — every folder and file, one line each.
- [Building your first tool](../01-core-data/02-tools.md) — hands-on.
