# The big idea — a brain that decides, hands that act
...
`LLM` = Large Language Model, the AI model. `Compact` = shrink the conversation (see [Compaction](../02-engine/06-compaction.md)).
...
- [Anatomy of a run](03-anatomy-of-a-run.md) — watch one full run travel through the brain and the hands.
- [The state machine](../02-engine/01-state-machine.md) — every rule the brain follows, in detail.
- [The driver loop](../02-engine/02-driver-loop.md) — every job the hands do, in detail.
- [The principles section](../09-principles/01-sans-io.md) — the ideas on this page ([sans-IO](../09-principles/01-sans-io.md), [state machines](../09-principles/02-state-machines.md), and more) explained from scratch.
