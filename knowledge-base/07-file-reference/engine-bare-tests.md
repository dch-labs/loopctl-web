# `src/engine/bare/tests.rs` — the engine's test suite
...
- Cross-file integration tests (`tests/`) cover subsystem seams end-to-end — see [examples & tests](examples-tests.md).

Deep dive: [Testing](../06-integration/05-testing.md).
