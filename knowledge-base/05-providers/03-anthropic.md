# Anthropic client — Claude, and how its quirks are handled
...
The Bedrock client's Anthropic-native path reuses this file's body builders, system folding, and stream emitter — one implementation, two transports. See [Bedrock](05-bedrock.md).
...
- [Overview](01-overview.md) · [Structured output](../06-integration/01-structured-output.md) · [Bedrock](05-bedrock.md)
