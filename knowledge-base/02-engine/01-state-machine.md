# The state machine — the brain, rule by rule
...
If you haven't yet, read [the big idea](../00-start-here/02-the-big-idea.md) first — this page goes deeper into every rule the brain follows.
...
1. The brain never does IO; it only decides. All doing belongs to the [driver](02-driver-loop.md).
...
- [State machines](../09-principles/02-state-machines.md) — the pattern this machine is an instance of, explained from scratch.
- [The driver loop](02-driver-loop.md) — the hands that execute these steps.
- [Compaction](06-compaction.md) — the full story of the Compact step.
- [File reference: machine.rs](../07-file-reference/engine-machine.md)
